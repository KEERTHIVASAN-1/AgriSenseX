      ...
      <main className="flex-1 px-4 sm:px-6 lg:px-10 xl:px-12 pt-6 pb-8 sm:pt-8 sm:pb-12 lg:pt-10 lg:pb-16 ">
        <div className="max-w-5xl lg:max-w-6xl mx-auto ">
            ...
            <div className="space-y-3 sm:space-y-4">
              {motorList.map((motor, idx) => {
                ...
                return (
                  <div
                    key={motor.id}
                    className="rounded-2xl border border-[#b8d4a0] bg-[#d4e8c4]/50 shadow-[0px_8px_13px_-5px_rgba(0,_0,_0,_0.35)] overflow-hidden"
                  >
                    {/* Motor header - click to expand/collapse */}
                    <div
                      className="flex items-center justify-between p-4 cursor-pointer bg-[background: #D9D9D9]"
                      onClick={() =>
                        setExpandedMotor(isExpanded ? null : motor.id)
                      }
                    >
                        ...
                        {mode === "manual" ? (
                          <div className="grid grid-cols-2 gap-4 ">
                            {["Valve 1", "Valve 2"].map((v) => (
                              <div
                                key={v}
                                className="rounded-xl bg-[#f3fae8] border border-[#b8d4a0] p-4 flex flex-col items-center gap-2 shadow-[4px_7px_3px_-3px_rgba(0,_0,_0,_0.35)]"
                              >
                          ...
                          <div className="grid grid-cols-2 gap-2 sm:gap-3">
                            {["Valve 1", "Valve 2"].map((v) => (
                              <div
                                key={v}
                                className="rounded-xl bg-[#f3fae8] border border-[#b8d4a0] p-2 sm:p-3 flex flex-col items-center shadow-[4px_7px_3px_-3px_rgba(0,_0,_0,_0.35)]"
                              >
                                {/* Valve Icon and Name */}
                                <div className="flex flex-col items-center gap-1 mb-2">
                                  ...
                                  <span className="font-bold text-[#2d3436] text-xs whitespace-nowrap">
                                    {v}
                                  </span>
                                </div>
          ...
          <section className="pt-6 sm:pt-8 border-t border-[#b8d4a0]/50">
            <h2 className="text-base sm:text-lg font-bold uppercase tracking-wider text-[#2d3436] mb-3 sm:mb-4">
              Other Devices
            </h2>
